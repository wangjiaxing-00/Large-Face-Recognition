...
def main():
    parser = ArgumentParser("InsightFace CLI tool", usage="rflm106det-cli <command> [<args>]")
    commands_parser = parser.add_subparsers(help="rflm106det-cli command-line helpers")
